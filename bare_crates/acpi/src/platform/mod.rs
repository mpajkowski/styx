...
use crate::{
    address::GenericAddress, fadt::Fadt, madt::Madt, AcpiError, AcpiHandler, AcpiResult,
    AcpiTables, PowerProfile,
};
use alloc::vec::Vec;
...
impl ProcessorInfo {
    pub(crate) fn new(boot_processor: Processor, application_processors: Vec<Processor>) -> Self {
        Self {
            boot_processor,
